...
/**
 * create_tree - creates AVL tree with recursion
 *
 * @node: pointer node
 * @array: input array of ints
 * @size: size of array
 * @mode: 1 to adding on left, 2 to adding on the right
 * Return: no return
 */
...
/**
 * sorted_array_to_avl - creates root node and calls create_tree
 *
 * @array: input array of ints
 * @size: size of array
