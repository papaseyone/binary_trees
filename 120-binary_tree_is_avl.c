 ...
 *
 * Return: If tree is NULL, your funct must return 0, else return height.
 */
size_t height(const binary_tree_t *tree)
{
if (tree)
 ...
 * @lo: The value of smallest node visited thus far.
 * @hi: The value of largest node visited this far.
 *
